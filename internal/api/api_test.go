...
func TestWebUIServed(t *testing.T) {
	...
	for _, want := range []string{
		`<canvas id="dashboard-preview" role="img" aria-label="Förhandsvisning av aktivt jobb"></canvas>`,
